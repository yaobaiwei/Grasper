 ...
 * be translate as following. for any result r generated by Tr, if after performing Tu
 * on r, the result set is empty, r need to go through Tr again. Else, r can be put into
